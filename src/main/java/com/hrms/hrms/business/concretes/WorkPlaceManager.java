...
import com.hrms.hrms.business.abstracts.WorkPlaceService;
...
public class WorkPlaceManager implements WorkPlaceService {
    ...
    public DataResult<List<WorkPlace>> getAll() {
        return new SuccessDataResult<List<WorkPlace>>(this.workPlaceDao.findAll(),"Work places have been listed");
    }
}
