...
public class FUCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FUCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FUCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FUCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FUCDateTimeConverter dateTimeConverter = new FUCStandardDateTimeConverter();

    public FUCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FUCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FUCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FUCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FUCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FUCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
