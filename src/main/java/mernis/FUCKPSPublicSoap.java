...
public class FUCKPSPublicSoap
{
    ...
    public FUCKPSPublicSoap(){}

    public FUCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FUCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FUCExtendedSoapSerializationEnvelope envelope= new FUCExtendedSoapSerializationEnvelope(FUCExtendedSoapSerializationEnvelope.VER11);
